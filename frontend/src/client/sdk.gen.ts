...
import type {
  ArticlesReadArticlesData,
  ArticlesReadArticlesResponse,
  ArticlesReadArticleData,
  ArticlesReadArticleResponse,
  IngestTriggerIngestResponse,
  ItemsReadItemsData,
...
export class ArticlesService {
  ...
  public static readArticles(
    data: ArticlesReadArticlesData = {},
  ): CancelablePromise<ArticlesReadArticlesResponse> {
  ...
  public static readArticle(
    data: ArticlesReadArticleData,
  ): CancelablePromise<ArticlesReadArticleResponse> {
    return __request(OpenAPI, {
      method: 'GET',
