      ...
      <div className="pb-14 pt-7 sm:pb-18 sm:pt-9">
        ...
        >
          ...
          <div className="max-w-[880px]">
            ...
            <p className="mt-5 max-w-[740px] text-base leading-7 text-slate-600 sm:text-lg sm:leading-8 dark:text-muted-foreground">
              A calm reading layer for important AI research, product launches,
              engineering posts, and trusted voices.
            </p>
            <p className="mt-4 max-w-[760px] text-xs font-medium uppercase tracking-[0.16em] text-slate-400 sm:text-[0.8125rem] dark:text-muted-foreground/75">
              AI labs · Research papers · Engineering blogs · Newsletters ·
              Trusted builders
            </p>
          </div>
          ...
          <main className="min-w-0">
            ...
            >
              <div className="mb-2 flex flex-col gap-3 sm:mb-3 sm:flex-row sm:items-end sm:justify-between">
                ...
                {latestUpdatedAt ? (
                  <p className="text-xs font-medium text-slate-500 dark:text-muted-foreground/85">
                    Updated {DateTime.fromMillis(latestUpdatedAt).toRelative()}
                  </p>
                ) : null}
              </div>
              {children}
...
function GuestSidebar() {
  return (
    <aside className="border-t border-slate-200/70 pt-7 lg:sticky lg:top-26 lg:self-start lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0 dark:border-border/70">
