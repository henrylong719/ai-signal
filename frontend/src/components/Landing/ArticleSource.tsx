  ...
  return (
    <div>
          ...
          sources.map((source: SourcePublic) => {
            ...
            return (
              <Link
                ...
                className="group flex items-center gap-3 rounded-md transition-colors hover:bg-slate-50 p-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900 focus-visible:ring-offset-2"
              >
      ...
      <Link
        ...
        className="inline-flex items-center rounded-sm text-xs font-sans font-medium text-slate-400 hover:text-slate-900 transition-colors mt-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900 focus-visible:ring-offset-2"
      >
