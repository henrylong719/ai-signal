  ...
  return (
    <div>
          ...
          sources.map((source: SourcePublic) => {
            ...
            return (
              <Link
                ...
                className="group flex items-center gap-3 rounded-lg border border-transparent p-2.5 transition-all hover:border-slate-200/80 hover:bg-white hover:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950/15 focus-visible:ring-offset-2"
              >
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-slate-50 text-slate-400 ring-1 ring-slate-100 transition-colors group-hover:bg-slate-950 group-hover:text-white group-hover:ring-slate-950">
                  <SourceTypeIcon className="h-4 w-4 stroke-[1.5]" />
                </div>
                <div className="min-w-0 flex-1">
                  <div className="flex items-center justify-between gap-3 ">
                    <h4 className="truncate font-serif font-medium leading-snug text-slate-950 transition-colors group-hover:text-slate-700">
                      {source.name}
                    </h4>
                  ...
                  <div className="mt-1 flex flex-wrap items-center gap-1.5 text-[11px] text-slate-500">
                    <Badge
                      variant="secondary"
                      className="h-5 border-slate-200/70 bg-white px-2 py-0 text-[11px] font-medium text-slate-500"
                    >
      ...
      <Link
        ...
        className="mt-3 inline-flex items-center rounded-sm text-xs font-semibold text-slate-500 transition-colors hover:text-slate-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950/15 focus-visible:ring-offset-2"
      >
